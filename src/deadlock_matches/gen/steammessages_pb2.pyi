...
class CGCSystemMsg_GetAccountDetails_Response(_message.Message):
    ...
    def __init__(self, eresult_deprecated: _Optional[int] = ..., account_name: _Optional[str] = ..., persona_name: _Optional[str] = ..., is_profile_created: _Optional[bool] = ..., is_profile_public: _Optional[bool] = ..., is_inventory_public: _Optional[bool] = ..., is_vac_banned: _Optional[bool] = ..., is_cyber_cafe: _Optional[bool] = ..., is_school_account: _Optional[bool] = ..., is_limited: _Optional[bool] = ..., is_subscribed: _Optional[bool] = ..., package: _Optional[int] = ..., is_free_trial_account: _Optional[bool] = ..., free_trial_expiration: _Optional[int] = ..., is_low_violence: _Optional[bool] = ..., is_account_locked_down: _Optional[bool] = ..., is_community_banned: _Optional[bool] = ..., is_trade_banned: _Optional[bool] = ..., trade_ban_expiration: _Optional[int] = ..., accountid: _Optional[int] = ..., suspension_end_time: _Optional[int] = ..., currency: _Optional[str] = ..., steam_level: _Optional[int] = ..., friend_count: _Optional[int] = ..., account_creation_time: _Optional[int] = ..., is_steamguard_enabled: _Optional[bool] = ..., is_phone_verified: _Optional[bool] = ..., is_two_factor_auth_enabled: _Optional[bool] = ..., two_factor_enabled_time: _Optional[int] = ..., phone_verification_time: _Optional[int] = ..., phone_id: _Optional[int] = ..., is_phone_identifying: _Optional[bool] = ..., rt_identity_linked: _Optional[int] = ..., rt_birth_date: _Optional[int] = ..., txn_country_code: _Optional[str] = ..., has_accepted_china_ssa: _Optional[bool] = ..., is_banned_steam_china: _Optional[bool] = ...) -> None: ...
